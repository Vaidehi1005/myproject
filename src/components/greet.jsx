...
// have props no use karisu so if mare name input karvu hase to hu props use karis to app.js ma aapde 3 greet component specify karisu <Greet name="a" /> <Greet name="b" /> <Greet name="c" />